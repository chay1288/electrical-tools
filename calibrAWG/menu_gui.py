...
class CircuitGUI(Circuit, Frame):
	...
	def prompt(self):
		...
		self.fases_label = Label(self.circuit_window, text="Fases: ")
		self.fases_label.grid(row=0,column=0, sticky=E)

		self.voltaje_label = Label(self.circuit_window, text="Voltaje: ")
		self.voltaje_label.grid(row=1,column=0, sticky=E)

		self.potencia_label = Label(self.circuit_window, text="Potencia: ")
		self.potencia_label.grid(row=2,column=0, sticky=E)

		self.factor_potencia_label = Label(self.circuit_window, text="Factor de Potencia: ")
		self.factor_potencia_label.grid(row=3,column=0, sticky=E)

		self.eficiencia_label = Label(self.circuit_window, text="Eficiencia: ")
		self.eficiencia_label.grid(row=4,column=0, sticky=E)

		self.longitud_label = Label(self.circuit_window, text="Longitud: ")
		self.longitud_label.grid(row=5,column=0, sticky=E)

		self.caida_tension_label = Label(self.circuit_window, text="Caída de Tensión Permitida: ")
		self.caida_tension_label.grid(row=6,column=0, sticky=E)

		self.conductores_conduit_label = Label(self.circuit_window, text="Conductores en Tubería Conduit: ")
		self.conductores_conduit_label.grid(row=7,column=0, sticky=E)

		self.temperatura_ambiente_label = Label(self.circuit_window, text="Temperatura Ambiente: ")
		self.temperatura_ambiente_label.grid(row=8,column=0, sticky=E)

		self.temperatura_conductor_label = Label(self.circuit_window, text="Temperatura de operación de conductor: ")
		self.temperatura_conductor_label.grid(row=9,column=0, sticky=E)

		self.temperatura_cc_label = Label(self.circuit_window, text="Temperatura de Cortocircuito de conductor: ")
		self.temperatura_cc_label.grid(row=10,column=0, sticky=E)

		self.ciclos_cc_label = Label(self.circuit_window, text="Ciclos de Cortocircuito: ")
		self.ciclos_cc_label.grid(row=11,column=0, sticky=E)

		self.corriente_cc_label = Label(self.circuit_window, text="Corriente de Cortocircuito: ")
		...
		self.factor_potencia_entry = Entry(self.circuit_window, textvariable=self.fp)
		...
		self.caida_tension_entry = Entry(self.circuit_window, textvariable=self.e)
		self.caida_tension_entry.grid(row=6,column=1)

		self.conductores_conduit_entry = Entry(self.circuit_window, textvariable=self.CTC)
		self.conductores_conduit_entry.grid(row=7,column=1)

		self.temperatura_ambiente_entry = Entry(self.circuit_window, textvariable=self.Ta)
		self.temperatura_ambiente_entry.grid(row=8,column=1)

		self.temperatura_conductor_entry = Entry(self.circuit_window, textvariable=self.Tc)
		self.temperatura_conductor_entry.grid(row=9,column=1)

		self.temperatura_cc_entry = Entry(self.circuit_window, textvariable=self.Tcc)
		...
		self.corriente_cc_entry = Entry(self.circuit_window, textvariable=self.Icc)
...
"""
		...
		self.about = Label(self, text=ABOUT)
	...
	def new_circuit(self):
		...
		self.cn = CircuitGUI(master=main_window) #objeto de CircuitGUI para aplicar sus metodos en la GUI 
		self.cn.prompt()

		# Frame de Botones en Ventana Principal
		self.buttons_windows = Frame(self.cn, relief=GROOVE, borderwidth=2)
		self.buttons_windows.pack(side=BOTTOM, padx=12, pady=12, anchor="e")

		# Crea botones y posiciona en Frame de Botones
		self.boton_AWG = Button(self.buttons_windows, text="Calcular AWG", bg="#154145", fg="WHITE", command=self.calcular)
		self.boton_AWG.pack(side=LEFT, padx=2, pady=2)

		self.boton_EXIT = Button(self.buttons_windows, text="Salir", fg="RED", command=main_window.destroy)
...
main_window.title("CalibrinAWG v.0.1.1")
