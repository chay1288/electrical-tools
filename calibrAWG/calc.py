...
#Z_max_p : Impedencia maxima
#e_gral  : porcentaje de caida de tension calculado para un calibre dado
...
def caida_tension(Z_cond, K_E, Ipc, Long, Volt):
    e_gral = (Z_cond*K_E*Long*Ipc)/(Volt*1000)
    return e_gral
